...
use crate::matrix::{Matrix4x4, MATRIX_4X4_IDENTITY, mul};
...
pub fn view_transform(from: Tuple, to: Tuple, up: Tuple) -> Matrix4x4 {
    ...
    mul(orientation, translation(-from.x, -from.y, -from.z))
}
...
mod tests {
    ...
    use crate::matrix::{inverse, Matrix4x4, matrix_4x4_eq, MATRIX_4X4_IDENTITY, mul_by_tuple};
    use crate::transformation::{rotation_x, rotation_y, rotation_z, scaling, shearing, translation, view_transform};
    use crate::tuple::Tuple;
    ...
    fn transformation_matrix_for_default_orientation() {
        ...
        assert_eq!(t, MATRIX_4X4_IDENTITY);
    }
    ...
    fn an_arbitrary_view_transformation() {
        ...
        assert!(matrix_4x4_eq(t, expected), "Expected: {:#?}\nActual: {:#?}", expected, t);
    }
}
